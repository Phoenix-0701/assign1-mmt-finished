...
peer_list = {}
# try:
#     # PeerManager chạy ở địa chỉ 127.0.0.1:50000 với authkey là b'secret'
#     BaseManager.register('get_peer_list')
#     manager = BaseManager(address=('127.0.0.1', 50001), authkey=b'secret')
#     manager.connect()  # Kết nối tới Manager
#     peer_list = manager.get_peer_list()  # Lấy dict chia sẻ
# except ConnectionRefusedError:
#     # Manager chưa chạy → fallback về dict riêng của process
#     peer_list = {}  # dict cục bộ
# except Exception:
#     # Bất kỳ lỗi nào khác khi connect
#     peer_list = {}
